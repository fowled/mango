...
module.exports = {
	...
	async execute(member: Discord.GuildMember, Client: Discord.Client) {
		...
		const embed = new Discord.MessageEmbed().setAuthor(member.user.tag, member.user.displayAvatarURL()).setDescription(`:frowning: See you soon ${member}`).setImage("attachment://welcome.png").setColor("#808080");
