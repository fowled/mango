...
module.exports = {
    ...
    async execute(Client: Discord.Client, interaction: Discord.ChatInputCommandInteraction) {
        const button = new Discord.ActionRowBuilder<Discord.ButtonBuilder>().addComponents(new Discord.ButtonBuilder().setLabel("Invite me!").setStyle(Discord.ButtonStyle.Link).setURL("https://discord.com/oauth2/authorize?client_id=497443144632238090&permissions=8&scope=bot"));
