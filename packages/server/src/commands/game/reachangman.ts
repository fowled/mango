...
module.exports = {
    ...
    async execute(_Client: Discord.Client, interaction: Discord.ChatInputCommandInteraction) {
        ...
        const firstMessageEmbed = new Discord.EmbedBuilder().setAuthor({
            name: interaction.user.username,
            iconURL: interaction.user.displayAvatarURL()
        }).setDescription("The game is currently initializating - please wait for the reactions to register.").setColor("#1E90FF");
            ...
            msg.awaitReactions({filter, max: 1})
                .then((collected) => {
                    ...
                    if (checkIfWin()) {
                        ...
                        }).setDescription(`You lost! Word was \`${thatOneWord}\`.`).setColor("#ff0000");
