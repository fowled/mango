	...
	<div class="container flex flex-wrap justify-between items-center">
		...
		<div class="flex">
			...
			{:then data}
				...
				{:else}
					<button>
						<a href={import.meta.env.VITE_REDIRECT_URI} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
							Login
						</a>
					</button>
				{/if}
