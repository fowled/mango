<script lang="ts">
	import { Github, Twitter } from "@steeze-ui/feather-icons";
	import { Icon } from "@steeze-ui/svelte-icon";
</script>

<section class="text-gray-700 bg-gray-50 dark:bg-gray-900 border-t dark:border-gray-800 border-gray-200">
